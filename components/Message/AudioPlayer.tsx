...
export default function AudioPlayer({ src, disableJustify }: IProps) {
    ...
    return (
        <div
            className={`flex items-center gap-2 ${
                disableJustify ? "" : "justify-between"
            } mb-1`}
        >
            ...
            <div className="flex w-full items-center gap-2 bg-audio-player p-2 rounded-full">
